...
const features = [
  {
    ...
    description:
      "Analyze previous INI-CET seat allotments across multiple counselling rounds to understand admission patterns at participating Institutes of National Importance.",
    colorKey: "blue",
  },
  {
    ...
    title: "Closing Ranks",
    description:
      "Review institute-wise and specialty-wise closing ranks from previous INI-CET sessions to estimate your admission chances.",
    colorKey: "indigo",
  },
  {
  ...
  },
  {
    ...
    title: "Rank Analysis",
    description:
      "Search any INI-CET rank to explore specialties and institutes that candidates secured in previous counselling rounds.",
    colorKey: "cyan",
  },
  {
    icon: <Target size={24} />,
    ...
    description:
      "Create, save, and optimize your INI-CET choice list with data-driven insights and personalized admission planning.",
    colorKey: "pink",
  },
  {
...
function InicetFeatures() {
  ...
  return (
    <section ref={sectionRef} className="inicet-feature">
      <div className="inicet-feature-container">
        <div className="inicet-feature-grid">
          <div className="inicet-feature-sticky-col">
            <div className="inicet-feature-dark-card">
              <h2 className="inicet-feature-dark-card-title">
                Plan,
                <br />
                Discover,
                <br />
          ...
          <div className="inicet-feature-list">
            {features.map((f, i) => (
              <div
                key={i}
                className={`inicet-feature-card is-${f.colorKey} ${
                  visible ? "is-visible" : ""
                }`}
                style={{ transitionDelay: `${i * 40}ms` }}
              >
                <div className={`inicet-feature-card-icon is-${f.colorKey}`}>
                  {f.icon}
                </div>
                <h3 className="inicet-feature-card-title">{f.title}</h3>
                <p className="inicet-feature-card-desc">{f.description}</p>
              </div>
            ))}
          </div>
        </div>
